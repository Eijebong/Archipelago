...
def fill_restrictive(multiworld: MultiWorld, base_state: CollectionState, locations: typing.List[Location],
                     ...
                     allow_partial: bool = False, allow_excluded: bool = False, name: str = "Unknown",
                     initial_bulk_fill: bool = False) -> None:
    """
    ...
    # of items to place.
    batcher = _RestrictiveFillBatcher(base_state, reachable_items, item_pool, True)  ## 0.5.1 does not have `one_item_per_player`
